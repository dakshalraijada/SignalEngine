...
/// <summary>
/// Repository interface for Metric (definition) operations.
/// </summary>
public interface IMetricRepository
{
    Task<Metric?> GetByIdAsync(int id, CancellationToken cancellationToken = default);
    Task<Metric?> GetByAssetAndNameAsync(int assetId, string metricName, CancellationToken cancellationToken = default);
