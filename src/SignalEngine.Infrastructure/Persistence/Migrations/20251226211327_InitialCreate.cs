        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCodeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    AllowWebhook = table.Column<bool>(type: "bit", nullable: false),
                    AllowSlack = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsecutiveBreaches = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    LastEvaluatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastMetricValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluationFrequencyId = table.Column<int>(type: "int", nullable: false),
                    ConsecutiveBreachesRequired = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RuleId = table.Column<int>(type: "int", nullable: false),
                    AssetId = table.Column<int>(type: "int", nullable: false),
                    SignalStatusId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    TriggerValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    ThresholdValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Signals_SignalId",
                        column: x => x.SignalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_SignalId",
                table: "Notifications",
                column: "SignalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rules_EvaluationFrequencyId",
                table: "Rules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignalStates_RuleId",
                table: "SignalStates",
                column: "RuleId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SignalStates_TenantId",
                table: "SignalStates",
                column: "TenantId");
